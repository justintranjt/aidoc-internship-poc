...
class MinidumpUploader {
    ...
    constructor(dsn, crashesDirectory, cacheDirectory) {
         ...
         * internet connection.
         */
        this.queue = new utils_1.Store(this.cacheDirectory, 'queue', []);
    ...
    getNewMinidumps() {
        return __awaiter(this, void 0, void 0, function* () {
            const minidumps = this.type === 'crashpad'
                ? yield this.scanCrashpadFolder()
                : yield this.scanBreakpadFolder();
            const oldestMs = new Date().getTime() - MAX_AGE * 24 * 3600 * 1000;
            return utils_1.filterAsync(minidumps, (path) => __awaiter(this, void 0, void 0, function* () {
    ...
    scanCrashpadFolder() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return files
                ...
                .map(file => path_1.join(dumpDirectory, file));
        });
    }
    ...
    scanBreakpadFolder() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return files
                .filter(file => file.endsWith('.dmp'))
                .map(file => path_1.join(this.crashesDirectory, file));
        });
    }
    /**
    ...
    queueMinidump(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield utils_1.mkdirp(this.cacheDirectory);
